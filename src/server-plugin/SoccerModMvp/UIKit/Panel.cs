// Vendored from nvmxre/cs2-ui-kit 2.0.0-preview.1 (MIT, see LICENSE-cs2-ui-kit.txt),
// https://github.com/nvmxre/cs2-ui-kit - trimmed to what the SoccerMod menu uses.
