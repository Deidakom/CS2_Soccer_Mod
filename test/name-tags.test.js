...
test('enemy name tags face the viewer and follow without parenting', () => {
  ...
  assert.ok(tags.includes('tag.Text.Teleport(new Vector(origin.X, origin.Y, origin.Z + eyes + NameTagAboveEyes), _nameTagAngles);'));
  assert.ok(tags.includes('NameTagFontSize = 48.0f'), '50% bigger than 32');
